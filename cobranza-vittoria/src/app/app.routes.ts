...
export const routes: Routes = [
  ...
  { path: 'marketing-publicidad', canActivate: [authGuard], component: GastosProyectoPage, data: { tipoModulo: 'marketing-publicidad', titulo: 'Marketing / Publicidad', subtitulo: 'Registro de publicidad y comisión por ventas por proyecto.', conceptos: ['PUBLICIDAD', 'COMISION POR VENTAS'] } },
  { path: 'otros-gastos', canActivate: [authGuard], component: GastosProyectoPage, data: { tipoModulo: 'otros-gastos', titulo: 'Otros Gastos', subtitulo: 'Registro de otros gastos por proyecto.', conceptos: ['OTROS GASTOS'] } },
  { path: 'gastos-municipales-distritales', canActivate: [authGuard], component: GastosProyectoPage, data: { tipoModulo: 'gastos-municipales-distritales', titulo: 'Gastos municipales y distritales', subtitulo: 'Registro de independización, declaratoria, conformidad e instalaciones por proyecto.', conceptos: ['INDEPENDIZACION', 'DECLARATORIA', 'CONFORMIDAD', 'INSTALACIONES'] } },
