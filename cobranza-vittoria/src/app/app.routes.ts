...
export const routes: Routes = [
  ...
  { path: 'marketing-publicidad', canActivate: [authGuard], component: GastosProyectoPage, data: { tipoModulo: 'marketing-publicidad', titulo: 'Marketing / Ventas', subtitulo: 'Registro de publicidad y comisión por ventas por proyecto.', conceptos: ['PUBLICIDAD', 'COMISION POR VENTAS'] } },
